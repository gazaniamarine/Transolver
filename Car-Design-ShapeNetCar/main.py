...
parser.add_argument('--data_dir', default='Car-Design-ShapeNetCar/dataset/mlcfd_data/mlcfd_data/training_data')
parser.add_argument('--save_dir', default='Car-Design-ShapeNetCar/dataset/mlcfd_data/mlcfd_data/preprocessed_data')
